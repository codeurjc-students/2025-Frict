...
describe('CartComponent', () => {
  ...
  const mockProduct: Product = {
    ...
    totalUnits: 100, availableUnits: 50, shopsWithStock: 3, averageRating: 4.5, totalReviews: 12, specifications: [], createdAt: '2026-05-08'
  };
  ...
  const mockFavProduct: Product = {
    ...
    shopsWithStock: 2, averageRating: 4.8, totalReviews: 20, specifications: [], createdAt: '2026-05-08'
  };
