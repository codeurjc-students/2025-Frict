...
import com.tfg.backend.service.NominatimGeocodingClient;
...
class LocationServiceUTest {
    ...
    void setUp() {
        ...
        geocodingClient = new NominatimGeocodingClient(builder.build());
    }
    ...
    class ReverseGeocode {
        ...
        void reverseGeocode_MapsAddressFields() {
            ...
            AddressDTO result = geocodingClient.reverseGeocode(40.4168, -3.7038);
        ...
        void reverseGeocode_FallbackFields() {
            ...
            AddressDTO result = geocodingClient.reverseGeocode(41.2364, 1.809);
        ...
        void reverseGeocode_NotFound_ReturnsNull() {
            ...
            assertNull(geocodingClient.reverseGeocode(0.0, 0.0));
        }
        ...
        void reverseGeocode_ProviderError() {
            ...
            ResponseStatusException ex = assertThrows(ResponseStatusException.class,
                    () -> geocodingClient.reverseGeocode(1.0, 1.0));
    ...
    class DirectGeocode {
        ...
        void directGeocode_ReturnsCoordinates() {
            ...
            CoordinatesDTO result = geocodingClient.directGeocode(input);
        ...
        void directGeocode_EmptyQuery() {
            ...
            ResponseStatusException exFromEmpty = assertThrows(ResponseStatusException.class,
                    () -> geocodingClient.directGeocode(empty));
            ...
            ResponseStatusException exFromNull = assertThrows(ResponseStatusException.class,
                    () -> geocodingClient.directGeocode(null));
        ...
        void directGeocode_NotFound_ReturnsNull() {
            ...
            assertNull(geocodingClient.directGeocode(input));
        }
    }
}
