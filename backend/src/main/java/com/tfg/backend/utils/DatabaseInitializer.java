...
public class DatabaseInitializer {
    ...
    public void init() throws IOException, SQLException {
        if (initEnabled) {
            ...
            Product product1 = new Product("A101", "Smartphone Plegable X", defaultProductBlob, "Innovación en diseño y potencia", 750.00);
            product1.setPreviousPrice(1000.00);
            ...
            product1.setCategories(List.of(mobile, topSales, featured));
            product2.setCategories(List.of(gaming, recommended, peripherals));
            product3.setCategories(List.of(gaming, peripherals, topSales));
            product4.setCategories(List.of(connectivity, smartHome));
            product5.setCategories(List.of(tvImage, peripherals, featured));
            product6.setCategories(List.of(photography, recommended));
            product7.setCategories(List.of(storage, gaming, topSales));
            product8.setCategories(List.of(peripherals, gaming, topSales));
            product9.setCategories(List.of(audio, smartHome, featured));
            product10.setCategories(List.of(audio, peripherals, topSales));
            product11.setCategories(List.of(mobile, recommended));
            product12.setCategories(List.of(photography, tools));
            product13.setCategories(List.of(power, mobile, tools));
            product14.setCategories(List.of(mobile, recommended));
            product15.setCategories(List.of(smartHome, featured));
            product16.setCategories(List.of(connectivity, tools));
            product17.setCategories(List.of(gaming, connectivity));
            product18.setCategories(List.of(gaming, featured, peripherals));
            product19.setCategories(List.of(peripherals, photography));
            product20.setCategories(List.of(tools, recommended));
            product21.setCategories(List.of(power, mobile));
            product22.setCategories(List.of(connectivity, smartHome));
            product23.setCategories(List.of(gaming, topSales, featured));
            product24.setCategories(List.of(smartHome, tools));
            product25.setCategories(List.of(audio, peripherals));
            product26.setCategories(List.of(connectivity, tools, topSales));
            product27.setCategories(List.of(gaming, tools));
            product28.setCategories(List.of(gaming, smartHome, tools));
            product29.setCategories(List.of(smartHome, recommended));
            product30.setCategories(List.of(smartHome, tvImage, featured));
