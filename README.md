...
> ℹ️ NOTE: Both online shop and management subsystems have login and register screens in common, so that the user will be redirected to one of them depending on the permissions level provided.
